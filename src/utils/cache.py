...
class CacheManager:
    ...
    async def cache_stock_data(self, symbol: str, data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
        """
    ...
    async def cache_stock_history(self, symbol: str, timeframe: str, data: List[Dict[str, Any]], ttl: Optional[int] = None) -> bool:
        """
    ...
    async def get_cached_stock_history(self, symbol: str, timeframe: str) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    async def cache_commodity_data(self, symbol: str, data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
        """
    ...
    async def cache_technical_indicators(self, symbol: str, indicators: Dict[str, Any], ttl: Optional[int] = None) -> bool:
        """
    ...
    async def get_cached_technical_indicators(self, symbol: str) -> Optional[Dict[str, Any]]:
        """
    ...
    # Portfolio cache
    async def cache_portfolio_data(self, user_id: str, portfolio_data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
        """
