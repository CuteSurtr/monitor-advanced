...
class DatabaseManager:
    ...
    async def get_stock_data(self, symbol: str, start_time: datetime, end_time: datetime) -> List[Dict[str, Any]]:
        """Get stock data for a symbol within a time range."""
        try:
            if self.config.database.type == "postgresql":
                return await self._get_stock_data_postgresql(symbol, start_time, end_time)
            else:
    ...
    async def _get_stock_data_postgresql(self, symbol: str, start_time: datetime, end_time: datetime) -> List[Dict[str, Any]]:
    ...
    async def _get_stock_data_influxdb(self, symbol: str, start_time: datetime, end_time: datetime) -> List[Dict[str, Any]]:
