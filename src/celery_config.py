"""
Celery configuration for Stock Market Monitor.
"""
...
_default_redis = f"redis://{config.redis.host}:{config.redis.port}/{config.redis.db}"
BROKER_URL = _env("CELERY_BROKER_URL", _default_redis)
BACKEND_URL = _env("CELERY_RESULT_BACKEND", _default_redis)
