...
class ForexDataCollector:
    ...
    def __init__(self, config, db_manager, cache_manager: CacheManager):
        ...
        self.forex_pairs = [
            ...
            'EUR/GBP', 'EUR/JPY', 'GBP/JPY', 'AUD/JPY', 'EUR/CHF', 'GBP/CHF', 'CHF/JPY',
            'EUR/AUD', 'EUR/CAD', 'GBP/AUD', 'GBP/CAD', 'AUD/CAD', 'CAD/JPY',
            'USD/CNY', 'USD/HKD', 'USD/SGD', 'USD/KRW', 'USD/INR', 'USD/MXN',
            'EUR/NOK', 'EUR/SEK', 'EUR/DKK', 'EUR/PLN', 'USD/NOK', 'USD/SEK'
        ]
        ...
        self.market_hours = {
            'sydney': {'open': '17:00', 'close': '02:00', 'timezone': 'Australia/Sydney'},
    ...
    async def start(self):
        ...
        try:
            while self.running:
                ...
                await asyncio.sleep(self.config.data_collection.forex_data_interval or 60)
    ...
    async def _collect_pair_data(self, pair: str):
        ...
        try:
            ...
            if data:
                ...
                self.logger.debug(f"Collected forex data for {pair}: {data.get('rate', 'N/A')}")
    ...
    async def _fetch_forex_data(self, pair: str) -> Optional[Dict[str, Any]]:
        ...
        for source_func in sources:
            try:
                ...
                self.logger.debug(f"Source {source_func.__name__} failed for {pair}: {e}")
                continue
                ...
                if response.status == 200:
                    ...
                    if 'Realtime Currency Exchange Rate' in data:
                        ...
                        return {
                            ...
                            'open': float(rate_data.get('2. From_Currency Name', 0)) if rate_data.get('2. From_Currency Name', '').replace('.', '').isdigit() else 0,
    ...
    async def get_historical_data(self, pair: str, start_date: datetime, end_date: datetime) -> List[Dict[str, Any]]:
