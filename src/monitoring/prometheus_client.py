...
class PrometheusClient:
    ...
    def record_prediction_accuracy(self, model_type: str, timeframe: str, accuracy: float):
    ...
    def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                'collection_active': self._metrics_thread is not None and self._metrics_thread.is_alive()
            }
        except Exception as e:
