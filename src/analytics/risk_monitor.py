...
class RiskMonitor:
    ...
    async def _check_portfolio_risk(self, portfolio_id: int):
        ...
        try:
            ...
            risk_metrics = await self.risk_analytics.calculate_portfolio_risk(portfolio_id)
    ...
    async def _check_volatility_thresholds(self, portfolio_id: int, risk_metrics: RiskMetrics):
    ...
    async def _check_drawdown_thresholds(self, portfolio_id: int, risk_metrics: RiskMetrics):
    ...
    async def _check_component_var_concentration(self, portfolio_id: int, risk_metrics: RiskMetrics):
        ...
        try:
            ...
            total_component_var = sum(abs(v) for v in risk_metrics.component_var.values())
    ...
    async def _check_correlation_risk(self, portfolio_id: int):
        ...
        try:
            correlation_matrix = await self.risk_analytics.calculate_portfolio_correlation_matrix(portfolio_id)
    ...
    async def _analyze_risk_trends(self, portfolio_id: int):
        ...
        try:
            ...
            if vol_trend > 0.05:  # Volatility increasing by more than 5% per measurement
                await self._send_risk_alert(
                    portfolio_id=portfolio_id,
    ...
    async def _send_risk_alert(self, portfolio_id: int, alert_type: str, level: str, 
