...
from src.portfolio.portfolio_manager import (
    PortfolioManager, Transaction, Position, PerformanceMetrics,
    RebalancingSuggestion, TaxOptimization
)
...
class PortfolioDashboard:
    ...
    def _create_layout(self) -> html.Div:
        ...
        return html.Div([
            ...
            dbc.Navbar(
                dbc.Container([
                    dbc.NavbarBrand("Portfolio Management Dashboard", className="ms-2"),
                    dbc.Nav([
                        ...
                        dbc.NavItem(dbc.NavLink("Tax Optimization", href="#tax")),
            ...
            dbc.Container([
                        ...
                        dbc.Col([
                            dbc.Card([
                                ...
                                dbc.CardBody([
                                    dbc.Row([
                                        dbc.Col([
                                            html.H4(id="total-value", children="Total Value: $0"),
                                            html.P(id="total-pnl", children="Total P&L: $0 (0%)")
                                        ], width=6),
                                        dbc.Col([
                                            html.H4(id="total-positions", children="Positions: 0"),
                                            html.P(id="total-return", children="Total Return: 0%")
                                        ], width=6)
                                    ])
                                ])
                            ])
                        ...
                        dbc.Col([
                            dbc.Card([
                                dbc.CardBody([
                                    ...
                                    html.P(id="daily-return", children="0%")
                                ])
                            ])
                        ], width=3),
                        dbc.Col([
                            dbc.Card([
                                dbc.CardBody([
                                    html.H5("Weekly P&L"),
                                    html.H3(id="weekly-pnl", children="$0"),
                                    html.P(id="weekly-return", children="0%")
                                ])
                            ])
                        ], width=3),
                        dbc.Col([
                            dbc.Card([
                                dbc.CardBody([
                                    ...
                                    html.H3(id="sharpe-ratio", children="0.0")
                                ])
                            ])
                        ], width=3),
                        dbc.Col([
                            dbc.Card([
                                dbc.CardBody([
                                    ...
                                    html.H3(id="max-drawdown", children="0%")
                                ])
                            ])
                        ], width=3)
                    ], className="mb-4")
                ...
                # Positions Section
                html.Div(id="positions-section", children=[
                    dbc.Row([
                        dbc.Col([
                            dbc.Card([
                ...
                # Performance Section
                html.Div(id="performance-section", children=[
                    dbc.Row([
                        dbc.Col([
                            dbc.Card([
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            dbc.Card([
                                dbc.CardHeader("Return Analysis"),
                                dbc.CardBody([
                ...
                # Rebalancing Section
                html.Div(id="rebalancing-section", children=[
                    dbc.Row([
                        dbc.Col([
                            dbc.Card([
                                dbc.CardHeader([
                                    "Rebalancing Suggestions",
                                    dbc.Button("Refresh", id="refresh-rebalancing", size="sm", className="ms-2")
                                ]),
                                dbc.CardBody([
                ...
                html.Div(id="tax-section", children=[
                    dbc.Row([
                        dbc.Col([
                            dbc.Card([
                                dbc.CardHeader("Tax Summary"),
                                dbc.CardBody([
                                    html.Div(id="tax-summary"),
                                    dcc.Graph(id="tax-breakdown-chart")
                                ])
                            ])
                        ], width=6),
                        dbc.Col([
                            dbc.Card([
                                dbc.CardHeader("Tax Loss Harvesting Opportunities"),
                                dbc.CardBody([
                                    html.Div(id="harvesting-opportunities")
                                ])
                            ])
                        ], width=6)
                    ], className="mb-4")
                ...
                html.Div(id="transactions-section", children=[
                    dbc.Row([
                        dbc.Col([
                            dbc.Card([
    ...
    def _setup_callbacks(self):
                ...
                for pos in positions:
                    row = dbc.Row([
                        ...
                        dbc.Col(
                            ...
                            width=2,
                            className="text-success" if pos['total_pnl'] > 0 else "text-danger"
                        )
                    ])
        ...
        async def update_rebalancing(n_clicks, portfolio_data):
            ...
            try:
                ...
                if positions:
                    ...
                    df["target_allocation"] = df["symbol"].map(target_allocations).fillna(0)
                ...
                return html.P("Error loading rebalancing data"), self._create_empty_figure()
        ...
        async def update_tax_optimization(portfolio_data):
            ...
            try:
                ...
                summary = html.Div([
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.P(f"${tax_opt.short_term_gains:,.2f}", className="text-success")
                        ], width=3),
                        dbc.Col([
                            html.H6("Long-term Gains"),
                            html.P(f"${tax_opt.long_term_gains:,.2f}", className="text-success")
                        ], width=3),
                        dbc.Col([
                            html.H6("Short-term Losses"),
                            html.P(f"${tax_opt.short_term_losses:,.2f}", className="text-danger")
                        ], width=3),
                        dbc.Col([
                            html.H6("Long-term Losses"),
                            html.P(f"${tax_opt.long_term_losses:,.2f}", className="text-danger")
                        ], width=3)
                    ], className="mb-3"),
                    dbc.Row([
                        dbc.Col([
                            html.H6("Net Capital Gains"),
                            html.P(f"${tax_opt.net_capital_gains:,.2f}", 
                                  className="text-success" if tax_opt.net_capital_gains > 0 else "text-danger")
                        ], width=6),
                        dbc.Col([
                ...
                fig = go.Figure(data=[
                    go.Pie(
                        labels=["Short-term Gains", "Long-term Gains", "Short-term Losses", "Long-term Losses"],
                        values=[
                ...
                if tax_opt.harvesting_opportunities:
                    ...
                    for opp in tax_opt.harvesting_opportunities:
                        row = dbc.Row([
                            ...
                            dbc.Col(f"${opp['estimated_tax_savings']:,.2f}", width=4)
                        ])
                    ...
                    opportunities = html.Div([
                        dbc.Row([
                            ...
                            dbc.Col("Unrealized Loss", width=3, className="fw-bold"),
                            dbc.Col("Quantity", width=2, className="fw-bold"),
                            dbc.Col("Est. Tax Savings", width=4, className="fw-bold")
                        ], className="mb-2"),
                        *opportunity_rows
                    ])
                else:
                    opportunities = html.P("No tax loss harvesting opportunities available")
                
                return summary, fig, opportunities
                
            except Exception as e:
                self.logger.error(f"Error updating tax optimization: {e}")
                return html.P("Error loading tax data"), self._create_empty_figure(), html.P("Error loading opportunities")
