...
if exist "grafana\dashboards\ultimate-financial-analytics-dashboard.json" (
...
if exist "grafana\dashboards\ULTIMATE_DASHBOARD_README.md" (
...
echo 3. Check 'Professional Analytics' folder for the Ultimate Dashboard
echo.
