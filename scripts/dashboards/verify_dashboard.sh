...
echo "- scripts/setup/setup_macro_influxdb.py - InfluxDB setup script"
echo "- scripts/services/start_macro_system.py - Data collection system"
echo "- grafana/provisioning/dashboards/macro_economic_dashboard.json - Grafana dashboard"
...
echo "2. Setup InfluxDB buckets: py scripts/setup/setup_macro_influxdb.py"
echo "3. Collect data: py scripts/services/start_macro_system.py"
