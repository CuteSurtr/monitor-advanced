...
async def main():
    ...
    try:
        ...
        logger.info("✓ VaR/CVaR calculation (Historical, Parametric, Monte Carlo)")
        logger.info("✓ Multiple volatility models (Historical, EWMA, GARCH)")
        logger.info("✓ Portfolio risk metrics (Sharpe ratio, Beta, Drawdown)")
        logger.info("✓ Correlation and concentration risk analysis")
        logger.info("✓ Component VaR for portfolio optimization")
        logger.info("✓ Stress testing with custom scenarios")
        logger.info("✓ Real-time risk monitoring and alerting")
        logger.info("✓ Multi-asset support (Equities, Forex, Crypto, Commodities)")
