...
async def main():
    ...
    try:
        ...
        print("\n📈 Example 1: Price Threshold Alert")
        ...
        print("\n📊 Example 4: Technical Indicator Alert")
        ...
        print("\n✏️ Example 6: Update Alert Condition")
        updates = {
            'threshold': 160.0,
            'severity': AlertSeverity.CRITICAL,
        ...
        print("\n⏸️ Example 7: Disable Alert Condition")
        ...
        print("\n🗑️ Example 8: Remove Alert Condition")
        ...
        print("\n🚀 Example 9: Start Alert Monitoring")
