...
class TestPortfolioManager:
    ...
    @pytest.mark.asyncio
    async def test_calculate_portfolio_metrics(self, portfolio_manager, sample_portfolio_data):
        """Test portfolio metrics calculation."""
        # Mock historical data
        historical_values = [
            {'date': datetime.utcnow() - timedelta(days=i), 'value': Decimal(f'{100000 + i * 100}')}\
            for i in range(30)
        ]
    ...
    @pytest.mark.asyncio
    async def test_get_portfolio_positions(self, portfolio_manager, sample_portfolio_data):
    ...
    @pytest.mark.asyncio
    async def test_calculate_risk_metrics(self, portfolio_manager, sample_portfolio_data):
        """Test risk metrics calculation."""
        # Mock historical data
        returns_data = [
            {'date': datetime.utcnow() - timedelta(days=i), 'return': 0.01 + (i % 5) * 0.002}
    ...
    @pytest.mark.asyncio
    async def test_get_portfolio_performance(self, portfolio_manager, sample_portfolio_data):
    ...
    @pytest.mark.asyncio
    async def test_generate_portfolio_report(self, portfolio_manager, sample_portfolio_data):
    ...
    @pytest.mark.asyncio
    async def test_get_cached_portfolio_data(self, portfolio_manager, sample_portfolio_data):
    ...
    async def test_error_handling(self, portfolio_manager):
        ...
        # Mock database error
        portfolio_manager.db_manager.execute_query.side_effect = Exception("Database error")
    ...
    @pytest.mark.asyncio
    async def test_concurrent_operations(self, portfolio_manager, sample_portfolio_data):
